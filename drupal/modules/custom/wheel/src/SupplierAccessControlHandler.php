 ...
 *
 * @see \Drupal\wheel\Entity\Supplier.
 */
class SupplierAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\wheel\Entity\SupplierInterface $entity */
    switch ($operation) {
      case 'view':
        if (!$entity->isPublished()) {
          return AccessResult::allowedIfHasPermission($account, 'view unpublished supplier entities');
        }
        return AccessResult::allowedIfHasPermission($account, 'view published supplier entities');
