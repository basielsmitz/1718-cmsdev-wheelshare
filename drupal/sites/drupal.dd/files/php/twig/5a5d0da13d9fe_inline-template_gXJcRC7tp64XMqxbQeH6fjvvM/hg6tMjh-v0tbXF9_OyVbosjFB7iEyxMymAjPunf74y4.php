...
class __TwigTemplate_d1dee4e31e2eacb5ce486bc9c604ffa05b2b2aec881c2917bcc3aa22d9b5747c extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/entity_view_display/{entity_view_display}</code>: GET", "{# inline_template_start #}<code>/entity/entity_view_display/{entity_view_display}</code>: GET", "");
    }
}
