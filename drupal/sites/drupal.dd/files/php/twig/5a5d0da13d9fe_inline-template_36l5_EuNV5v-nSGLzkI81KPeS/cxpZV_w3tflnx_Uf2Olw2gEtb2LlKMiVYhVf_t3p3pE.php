...
class __TwigTemplate_4145e5ed9a13a9bbbf02d131753f8b3333e624d277148f5ebd72b471a47e869e extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/admin/config/user-interface/shortcut/link/{shortcut}</code>: GET, PATCH, DELETE</br><code>/entity/shortcut</code>: POST", "{# inline_template_start #}<code>/admin/config/user-interface/shortcut/link/{shortcut}</code>: GET, PATCH, DELETE</br><code>/entity/shortcut</code>: POST", "");
    }
}
