...
class __TwigTemplate_07e48e9ecb6e5a8dd6d7e3f87ab2532fbed9e845c2a1bd6117a87e42060057a8 extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/user/{user}</code>: GET, PATCH, DELETE</br><code>/entity/user</code>: POST", "{# inline_template_start #}<code>/user/{user}</code>: GET, PATCH, DELETE</br><code>/entity/user</code>: POST", "");
    }
}
