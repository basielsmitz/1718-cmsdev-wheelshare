...
class __TwigTemplate_0c5576cfce89002e0559dde9f0a3c77e82da3fbd7eb046f5ff129f4b25bfadcb extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/admin/structure/menu/item/{menu_link_content}/edit</code>: GET, PATCH, DELETE</br><code>/entity/menu_link_content</code>: POST", "{# inline_template_start #}<code>/admin/structure/menu/item/{menu_link_content}/edit</code>: GET, PATCH, DELETE</br><code>/entity/menu_link_content</code>: POST", "");
    }
}
