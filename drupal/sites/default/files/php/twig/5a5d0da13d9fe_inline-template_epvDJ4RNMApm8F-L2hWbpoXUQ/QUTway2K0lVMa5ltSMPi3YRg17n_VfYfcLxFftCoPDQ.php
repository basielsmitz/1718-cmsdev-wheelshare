...
class __TwigTemplate_231b7bd113b836bf7cced2b26f0894ebbd73f34d4646d161fd9f7c55873d9acd extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/file/{file}</code>: GET, PATCH, DELETE</br><code>/entity/file</code>: POST", "{# inline_template_start #}<code>/entity/file/{file}</code>: GET, PATCH, DELETE</br><code>/entity/file</code>: POST", "");
    }
}
