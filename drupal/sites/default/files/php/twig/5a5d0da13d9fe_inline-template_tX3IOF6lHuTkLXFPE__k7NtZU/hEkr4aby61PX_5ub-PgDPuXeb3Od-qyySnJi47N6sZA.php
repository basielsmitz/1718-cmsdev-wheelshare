...
class __TwigTemplate_7f4c636be92ff9f697c1f4520f866c7cd84ada3af0a19da51b3e921d3cf9d100 extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/filter_format/{filter_format}</code>: GET", "{# inline_template_start #}<code>/entity/filter_format/{filter_format}</code>: GET", "");
    }
}
