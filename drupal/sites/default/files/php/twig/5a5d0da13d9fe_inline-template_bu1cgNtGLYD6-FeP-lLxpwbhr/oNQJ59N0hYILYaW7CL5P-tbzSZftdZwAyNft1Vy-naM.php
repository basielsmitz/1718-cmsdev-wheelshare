...
class __TwigTemplate_0231661a39d6b2087eb937ca618dc0941eea3fb2d9ab901fc3d7d61ce792ed51 extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/contact_message/{contact_message}</code>: GET, PATCH, DELETE</br><code>/entity/contact_message</code>: POST", "{# inline_template_start #}<code>/entity/contact_message/{contact_message}</code>: GET, PATCH, DELETE</br><code>/entity/contact_message</code>: POST", "");
    }
}
