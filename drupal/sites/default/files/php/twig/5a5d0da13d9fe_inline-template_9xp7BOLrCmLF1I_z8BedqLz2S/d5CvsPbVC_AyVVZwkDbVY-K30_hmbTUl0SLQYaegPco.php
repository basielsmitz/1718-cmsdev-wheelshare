...
class __TwigTemplate_f6869591fcac06938ac6597189cbda1c1371e6744f306b26e9b03af3b443e33a extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/block_content_type/{block_content_type}</code>: GET", "{# inline_template_start #}<code>/entity/block_content_type/{block_content_type}</code>: GET", "");
    }
}
