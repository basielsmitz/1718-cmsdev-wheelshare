...
class __TwigTemplate_a3b6abe95ffda0afadc6ee69e5ffab8add0f01d3244f54639d44dbce995c9881 extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/entity_view_mode/{entity_view_mode}</code>: GET", "{# inline_template_start #}<code>/entity/entity_view_mode/{entity_view_mode}</code>: GET", "");
    }
}
