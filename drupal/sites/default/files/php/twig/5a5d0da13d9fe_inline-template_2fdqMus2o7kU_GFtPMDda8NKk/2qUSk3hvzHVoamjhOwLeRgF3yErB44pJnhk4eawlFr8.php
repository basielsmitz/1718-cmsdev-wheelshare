...
class __TwigTemplate_fbedfc735f05a10fce710971e1f2587d015b191112cc2953d916bd7d5cf6a042 extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/comment_type/{comment_type}</code>: GET", "{# inline_template_start #}<code>/entity/comment_type/{comment_type}</code>: GET", "");
    }
}
