...
class __TwigTemplate_72042ed76cc0aab1647f652ae05aee565022e6b78c8269ba3c9428d4f88c67b4 extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/entity_form_mode/{entity_form_mode}</code>: GET", "{# inline_template_start #}<code>/entity/entity_form_mode/{entity_form_mode}</code>: GET", "");
    }
}
