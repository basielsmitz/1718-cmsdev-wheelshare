...
class __TwigTemplate_f46e1176654d1352a70bef49c10eb3f2b43469086c19cd1de16a082ddfe0fbea extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/rest_resource_config/{rest_resource_config}</code>: GET", "{# inline_template_start #}<code>/entity/rest_resource_config/{rest_resource_config}</code>: GET", "");
    }
}
