...
class __TwigTemplate_831dd62a904ec9bde98acd5422519eae9bd320dcfb1cd707079adacdd672fdc7 extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/date_format/{date_format}</code>: GET", "{# inline_template_start #}<code>/entity/date_format/{date_format}</code>: GET", "");
    }
}
