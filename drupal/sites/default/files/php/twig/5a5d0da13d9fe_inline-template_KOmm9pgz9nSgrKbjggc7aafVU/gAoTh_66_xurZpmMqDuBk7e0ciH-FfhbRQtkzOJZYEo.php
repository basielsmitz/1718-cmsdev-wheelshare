...
class __TwigTemplate_8b6fe49c3884e32b5c811c1ffb1aa2e49a097ab9bcf4b0686e68b09d5847f90f extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/shortcut_set/{shortcut_set}</code>: GET", "{# inline_template_start #}<code>/entity/shortcut_set/{shortcut_set}</code>: GET", "");
    }
}
