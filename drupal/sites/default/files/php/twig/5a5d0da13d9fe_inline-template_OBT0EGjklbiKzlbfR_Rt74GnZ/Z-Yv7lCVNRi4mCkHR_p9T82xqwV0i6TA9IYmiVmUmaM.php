...
class __TwigTemplate_653db0574559a2ccc578b4cbb78f6c6ee132c275ab3d923c5b897589ab684d9a extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<code>/entity/entity_form_display/{entity_form_display}</code>: GET", "{# inline_template_start #}<code>/entity/entity_form_display/{entity_form_display}</code>: GET", "");
    }
}
