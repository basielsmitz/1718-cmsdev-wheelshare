    ...
    <div class="User">
        ...
        <div class="content">
            <div class="userInfo">
                ...
                <router-link class="secondaryButtonLink" :to="{ name: 'UserDetail'}"><button class="secondaryButton" type="button">Meer</button></router-link>
            </div>
            <h3>Reservaties</h3>
            <div class="reservations">
                ...
                <router-link class="secondaryButtonLink" :to="{ name: 'UserHistory'}"><button class="secondaryButton" type="button">Meer</button></router-link>
            </div>
        </div>
    </div>
</template>
